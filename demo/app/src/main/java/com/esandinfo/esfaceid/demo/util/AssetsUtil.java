...
/**
 * @ProjectName: esfaceid-android
 * @Package: com.esandinfo.esfaceid.demo.utile
 * @ClassName: AssetsUtil
 * @Description: Assets工具类
 * @Author: 北京一砂信息技术有限公司
 * @CreateDate: 2022/5/8 12:50 下午
 * @UpdateUser: 更新者：
 * @UpdateDate: 2022/5/8 12:50 下午
 * @UpdateRemark: 更新说明：
 * @Version: 1.0
 */
